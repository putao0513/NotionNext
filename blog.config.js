...
const BLOG = {
API_BASE_URL: process.env.API_BASE_URL || 'https://www.notion.so/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3  // Important page_id！！！Duplicate Template from  https://tanghh.notion.site/02ab3b8678004aa69e9e415905ef32a5
  NOTION_PAGE_ID:
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的地球人🌍', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-xxic.vercel.app/', // 网站地址
